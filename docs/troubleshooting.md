...
- Need manual vehicle control: use `ros2 launch carkit_vehicle_control controller.launch.py` for the F1TENTH gamepad/controller stack, or `ros2 launch carkit_vehicle_control keyboard.launch.py` for keyboard Ackermann commands.
