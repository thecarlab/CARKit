...
- Need manual vehicle control: use `ros2 launch carkit_vehicle_control controller_only.launch.py` when a controller publishes `/joy_cmd`, or `ros2 launch carkit_vehicle_control ackermann_input.launch.py start_keyboard:=true` for keyboard Ackermann commands.
