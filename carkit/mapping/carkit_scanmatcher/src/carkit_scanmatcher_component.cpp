...
void ScanMatcherComponent::initializePubSub()
{
  ...
  map_array_pub_ =
    create_publisher<carkit_lidarslam_msgs::msg::MapArray>(
...
void ScanMatcherComponent::publishMap(const carkit_lidarslam_msgs::msg::MapArray & map_array_msg , const std::string & map_frame_id)
{
