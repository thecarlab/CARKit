...
#include "carkit_scanmatcher/lidar_undistortion.hpp"
...
private:
    ...
    rclcpp::Publisher < carkit_lidarslam_msgs::msg::MapArray > ::SharedPtr map_array_pub_;
    ...
    void publishMap(const carkit_lidarslam_msgs::msg::MapArray & map_array_msg, const std::string & map_frame_id);
    void updateMap(
      const pcl::PointCloud < pcl::PointXYZI > ::ConstPtr cloud_ptr,
      const Eigen::Matrix4f final_transformation,
