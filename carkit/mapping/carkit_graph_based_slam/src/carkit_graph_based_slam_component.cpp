...
: Node("carkit_graph_based_slam", options),
  clock_(RCL_ROS_TIME),
...
void GraphBasedSlamComponent::initializePubSub()
{
  ...
  auto map_array_callback =
    [this](const typename carkit_lidarslam_msgs::msg::MapArray::SharedPtr msg_ptr) -> void
    {
  ...
  map_array_sub_ =
    create_subscription<carkit_lidarslam_msgs::msg::MapArray>(
  ...
  modified_map_array_pub_ = create_publisher<carkit_lidarslam_msgs::msg::MapArray>(
...
void GraphBasedSlamComponent::searchLoop()
{
  ...
  carkit_lidarslam_msgs::msg::MapArray map_array_msg = map_array_msg_;
  std::lock_guard<std::mutex> lock(mtx_);
  ...
  carkit_lidarslam_msgs::msg::SubMap latest_submap;
  ...
  carkit_lidarslam_msgs::msg::SubMap min_submap;
...
void GraphBasedSlamComponent::doPoseAdjustment(
  carkit_lidarslam_msgs::msg::MapArray map_array_msg,
  bool do_save_map)
{
  ...
  carkit_lidarslam_msgs::msg::MapArray modified_map_array_msg;
  ...
  for (int i = 0; i < submaps_size; i++) {
    ...
    *map_ptr += *transformed_cloud_ptr;
    ...
    /* submap */
    carkit_lidarslam_msgs::msg::SubMap submap;
