...
#include <carkit_lidarslam_msgs/msg/map_array.hpp>
...
private:
    ...
    carkit_lidarslam_msgs::msg::MapArray map_array_msg_;
    rclcpp::Subscription < carkit_lidarslam_msgs::msg::MapArray > ::SharedPtr map_array_sub_;
    rclcpp::Publisher < carkit_lidarslam_msgs::msg::MapArray > ::SharedPtr modified_map_array_pub_;
    ...
    void searchLoop();
    void doPoseAdjustment(carkit_lidarslam_msgs::msg::MapArray map_array_msg, bool do_save_map);
