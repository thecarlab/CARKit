...
```
carkit_pure_pursuit/
├── include/carkit_pure_pursuit/
│   └── carkit_pure_pursuit.hpp    # Main controller class
├── src/
│   ├── carkit_pure_pursuit.cpp    # Controller implementation
...
# Build the package
colcon build --packages-select carkit_pure_pursuit
...
ros2 launch carkit_pure_pursuit waypoint_recorder.launch.py output_file:=my_waypoints.yaml
...
ros2 launch carkit_pure_pursuit pure_pursuit_system.launch.py waypoints_file:=my_waypoints.yaml
```
...
```bash
# Launch path loader
ros2 launch carkit_pure_pursuit path_loader.launch.py waypoints_file:=my_waypoints.yaml

# Launch pure pursuit controller
ros2 launch carkit_pure_pursuit pure_pursuit.launch.py
```
