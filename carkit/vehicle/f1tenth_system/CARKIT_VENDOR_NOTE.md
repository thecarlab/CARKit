...
CARKit vendors this code so the controller, keyboard, Ackermann mux, and VESC driver stack build inside the single `ariiees/carkit:latest` Docker environment.
